...
<div class="container-fluid">
  ...
  <a href="#"><img class="smaller-image thick-green-border" src="https://cdn.freecodecamp.org/curriculum/cat-photo-app/relaxing-cat.jpg" alt="A cute orange cat lying on its back.">
    <img class="thick-green-border img-responsive" src="https://cdn.freecodecamp.org/curriculum/cat-photo-app/running-cats.jpg" alt="A cute orange cat lying on its back.">
  </a>
...
<div class="container-fluid">
  ...
  <form action="https://freecatphotoapp.com/submit-cat-photo">
    <div class="row">
      ...
      <label>
        <div class="col-xs-6"><input type="radio" name="indoor-outdoor"> Outdoor</div></label>
      <label><div class="col-xs-6"><input type="checkbox" name="personality"> Loving</div></label>
      <label><div class="col-xs-6"><input type="checkbox" name="personality"> Lazy</div>/label>
      <label><div class="col-xs-6"><input type="checkbox" name="personality"> Crazy</div></label>
      <input type="text" placeholder="cat photo URL" required>
      <button type="submit">Submit</button>
  </form>
</div>
